...
let host = 'http://zyb-api.mibyi.com/api';
// let host = 'http://127.0.0.1:8000';
let local_host = 'http://zyb-api.mibyi.com/api';
...
export const register = parmas => { return axios.post(`${host}/reg_user/`, parmas) }

//短信
export const getMessage = parmas => { return axios.post(`${host}/codes/`, parmas) }


//获取用户信息
export const getUserDetail = () => { return axios.get(`${local_host}/reg_user/1/`) }

//修改用户信息
export const updateUserInfo = params => { return axios.patch(`${host}/reg_user/1/`, params) }


//获取订单
export const getOrders = () => { return axios.get(`${host}/orders/`) }
// //获取订单
// export const getOrders = () => { return axios.get(`http://hwl.free.idcfengye.com/api/orders/`) }
//删除订单
...
// //获取订单详情
// export const getOrderDetail = orderId => {return axios.get(`http://hwl.free.idcfengye.com/api/orders/`+orderId+'/')}


//获取留言
export const getMessages = () => {return axios.get(`${host}/usermsg/`)}

//添加留言
export const addMessage = params => {return axios.post(`${host}/usermsg/`, params, {headers:{ 'Content-Type': 'multipart/form-data' }})}

//删除留言
export const delMessages = messageId => {return axios.delete(`${host}/usermsg/`+messageId+'/')}
