...
<div class="c-box bg-box" >
    <div class="login-box clearfix"style="margin-top:10px">
        ...
        <div class="fr form-box">
            <div class="tab">
                <h2 style="font-size: 18px">手机注册</h2>
            </div>
            <div class="tab-form">
                <form id="mobile_register_form" autocomplete="off">
                    ...
                    <div class="form-group marb20">
                        <label>手&nbsp;机&nbsp;号</label>
                        <input id="jsRegMobile" name="account" v-model="mobile" @focus="errorUnshow" type="text" placeholder="请输入您的手机号码">
                    </div>
                    ...
                    <div class="clearfix marb8">
                        <div class="form-group marb8 verify-code">
                            <label>短信验证码</label>
                            <input id="jsPhoneRegCaptcha" v-model="code" @focus="errorUnshow" type="text" placeholder="输入手机验证码">
                        </div>
                        <input ref="getCode" class="verify-code-btn sendcode" type="button" id="jsSendCode" @click="seedMessage" :value="getMessageText">
                    </div>
                     <p class="error-text marb8" v-show="error.code">{{error.code}}</p>

                    <div class="form-group marb8">
                        <label>密&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;码</label>
                        <input id="jsPhoneRegPwd" name="password_m" type="password" v-model="password" @focus="errorUnshow" placeholder="请输入6-20位非中文字符密码">
                    </div>
      ...
      seedMessage() {
        ...
        function settime () {
          if (countdown == 0) {
            ...
            countdown = 60;
            that.$refs.getCode.setAttribute('disabled', 'false')
            return;
          } else {
            that.$refs.getCode.setAttribute('disabled', 'true')
